...
def SimpleConv(input_shape, use_HER):
    ...
    conv5 = Conv2D(64, (5, 1), activation='relu', padding='SAME')(conv0)
    conv9 = Conv2D(64, (9, 1), activation='relu', padding='SAME')(conv0)
    conv13= Conv2D(64, (13,1), activation='relu', padding='SAME')(conv0)
    conv15= Conv2D(64, (15,1), activation='relu', padding='SAME')(conv0)
